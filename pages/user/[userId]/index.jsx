    ...
    <div id="page-content" className="UserProfile-Page">
      ...
      <div id="body" className='fl_col gp20'>
            ...
            <div className="user-box fl_col gp20">
              ...
              <div className="user-tabs">
                <ul className="fl_row gp50 p14 txt_light-grey">
                  <li onClick={() => handleTabClick("videos")} className={activeTab === "videos" ? "active-tab" : ""}>Videos</li>
                  <li onClick={() => handleTabClick("followers")} className={activeTab === "followers" ? "active-tab" : ""}>Followers</li>
                  <li onClick={() => handleTabClick("following")} className={activeTab === "following" ? "active-tab" : ""}>Following</li>
                  <li onClick={() => handleTabClick("about")} className={activeTab === "about" ? "active-tab" : ""}>About</li>
                </ul>
              </div>
            </div>
        ...
        <div className="content-tabs pd40">
          {activeTab === "videos" && <ListingVideosProfile />}
          {activeTab === "followers" && <FollowersProfile />}
          {activeTab === "following" && <FollowingProfile />}
